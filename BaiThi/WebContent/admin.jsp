...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="adminKHController">QL khách hàng</a></li>
      <li><a href="adminLoaiController">QL loại sản phẩm</a></li>
      <li><a href="adminSP">QL  sản phẩm</a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
		...
		%>
		 ...
		 <li><a href="dangxuatadmin"><span class="glyphicon glyphicon-user"></span> Đăng Xuất</a></li>
           <%}else{ %>
